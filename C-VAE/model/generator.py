...
class Generator(nn.Module):
    ...
    def forward(self, drop_prob, encoder_input=None, decoder_input=None,
        ...
        if z is None:
            ...
            mu, logvar = self.encoder(encoder_input[0], target=encoder_input[1])
            ...
            mu, logvar = self.encoder(encoder_input[0], input_target=None)
            std = t.exp(0.5 * logvar)
        ...
        out1, final_state1 = self.decoder(decoder_input[0], decoder_input[1],
